An asset with "physics" imported in the game, apparently. # Lethal Company Mod Template
...
<!-- BepInEx Properties -->
<PropertyGroup>
    <AssemblyName>silk.myHelicoptermod</AssemblyName>
    <Product>MyHelicopterMod</Product>
...
namespace MyHelicopterMod.Patches;
